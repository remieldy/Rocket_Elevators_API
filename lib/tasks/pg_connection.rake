    ...
    task datawarehouse: :environment do
        ...
        #     end
            ...
            Intervention.all.each do |intervention|
                conn.exec("INSERT INTO \"factIntervention\" (intervention_id, user_id, building_id, battery_id, column_id, elevator_id, intervention_start, intervention_finish, intervention_result, report, status) 
