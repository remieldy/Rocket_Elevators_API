    ...
    task datawarehouse: :environment do
        ...
        #     end
            ...
            Intervention.all.each do |intervention|
                ...
                VALUES (#{id}, #{intervention.user_id}, #{intervention.building_id}, #{intervention.battery_id.blank? ? 'NULL' : intervention.battery_id}, #{intervention.column_id.blank? ? 'NULL' : intervention.column_id}, #{intervention.elevator_id.blank? ? 'NULL' : intervention.elevator_id}, '#{intervention.intervention_start}',
